...
The result here is very bad, as it predict all response as "Tumor". We do not want that.

#### **You are allowed to use any means to predict the "**response" **and "tissue" of the test set!**
